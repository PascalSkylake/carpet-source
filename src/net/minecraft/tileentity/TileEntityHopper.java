...
public class TileEntityHopper extends TileEntityLockableLoot implements IHopper, ITickable, ILazyTileEntity
{
    ...
    public static boolean pullItems(IHopper hopper)
    {
        ...
        if (iinventory != null)
        {
            ...
            if (isInventoryEmpty(iinventory, enumfacing))
            {
                ...
                if(iinventory instanceof TileEntityLockable && hopper instanceof TileEntityHopper)
                {
                    ((TileEntityHopper)hopper).pullSleeping = true;
                }
    ...
    private static boolean pullItemFromSlot(IHopper hopper, IInventory inventoryIn, int index, EnumFacing direction)
    {
        ...
        if(CarpetSettings.autocrafter && TileEntityCraftingTable.checkIfCanCraft(hopper, inventoryIn, itemstack)){
            return false;
        }
