...
public class BlockChest extends BlockContainer implements Meterable /* RSMM */, PowerSource /* RSMM */
{
    ...
    {
        if (source.getBlockState(pos.north(), "Chest loading").getBlock() == this)
        {
            return NORTH_CHEST_AABB;
        }
        else if (source.getBlockState(pos.south(), "Chest loading").getBlock() == this)
        {
            return SOUTH_CHEST_AABB;
        }
        else if (source.getBlockState(pos.west(), "Chest loading").getBlock() == this)
        {
            return WEST_CHEST_AABB;
        }
        else
        {
            return source.getBlockState(pos.east(), "Chest loading").getBlock() == this ? EAST_CHEST_AABB : NOT_CONNECTED_AABB;
        }
    }
    ...
    public void onBlockAdded(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL)
        {
            ...
            IBlockState iblockstate = worldIn.getBlockState(blockpos, "Chest loading");
    ...
    public IBlockState checkForSurroundingChests(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        {
            IBlockState iblockstate = worldIn.getBlockState(pos.north(), "Chest loading");
            IBlockState iblockstate1 = worldIn.getBlockState(pos.south(), "Chest loading");
            IBlockState iblockstate2 = worldIn.getBlockState(pos.west(), "Chest loading");
            IBlockState iblockstate3 = worldIn.getBlockState(pos.east(), "Chest loading");
            ...
            if (iblockstate.getBlock() != this && iblockstate1.getBlock() != this)
            {
                ...
                if (iblockstate2.getBlock() == this || iblockstate3.getBlock() == this)
                {
                    ...
                    IBlockState iblockstate7 = worldIn.getBlockState(blockpos1.north(), "Chest loading");
                    IBlockState iblockstate6 = worldIn.getBlockState(blockpos1.south(), "Chest loading");
            ...
            else
            {
                ...
                IBlockState iblockstate4 = worldIn.getBlockState(blockpos.west(), "Chest loading");
                IBlockState iblockstate5 = worldIn.getBlockState(blockpos.east(), "Chest loading");
    ...
    private boolean isDoubleChest(World worldIn, BlockPos pos)
    {
        ...
        else
        {
            for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL)
            {
                if (worldIn.getBlockState(pos.offset(enumfacing), "Chest loading").getBlock() == this)
                {
                    return true;
                }
            }
    ...
    public ILockableContainer getContainer(World worldIn, BlockPos pos, boolean allowBlocking)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    BlockPos blockpos = pos.offset(enumfacing);
                    Block block = worldIn.getBlockState(blockpos, "Chest loading").getBlock();
