...
public class BlockRedstoneWire extends Block implements MeterableBlock /* RSMM */, PowerSource /* RSMM */
{
    ...
    public IBlockState calculateCurrentChanges(World worldIn, BlockPos pos1, BlockPos pos2, IBlockState state)
    {
        ...
        logPowered(worldIn, pos1, j > MIN_POWER); // RSMM
    ...
    public int getWeakPower(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side)
    {
        ...
        if (CarpetSettings.redstoneOreRedirectsDust)
        {
            ...
            return redstoneOre.getWeakPowerCM(blockState, blockAccess, pos, side);
        }
        ...
        else
        {
            ...
            IBlockState iblockstate = blockAccess.getBlockState(pos.offset(side.getOpposite())); // [CM] RS Ore redirects dust
    ...
    public boolean isPowerSourceAt(IBlockAccess worldIn, BlockPos pos, EnumFacing side)
    {
    ...
    protected static boolean canConnectTo(IBlockState blockState, @Nullable EnumFacing side)
    {
        ...
        if (CarpetSettings.redstoneOreRedirectsDust)
        {
            return RedstoneOreRedirectHelper.canConnectToCM(blockState, side);
        }
    ...
    public boolean isPowered(World world, BlockPos pos, IBlockState state) {
        return state.getValue(POWER) > MIN_POWER;
    }
