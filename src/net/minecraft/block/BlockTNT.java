...
public class BlockTNT extends Block
{
    ...
    public void onBlockAdded(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (!CarpetSettings.TNTDoNotUpdate && worldIn.isBlockPowered(pos))
        {
    ...
    {
        if(CarpetSettings.duplicationFixMovingTNT && BlockPistonBase.isBeingPushed(pos)) return; // Added duplication fix for moving TNT CARPET-XCOM
