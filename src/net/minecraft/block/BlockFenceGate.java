...
public class BlockFenceGate extends BlockHorizontal implements MeterableBlock /* RSMM */
{
    ...
    {
        return (worldIn.getBlockState(pos.down()).getMaterial().isSolid()  || CarpetSettings.relaxedBlockPlacement )? super.canPlaceBlockAt(worldIn, pos) : false; // CM added condition to place in mid air
    }
