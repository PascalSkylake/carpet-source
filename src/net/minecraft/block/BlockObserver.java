...
public class BlockObserver extends BlockDirectional implements Meterable /* RSMM */, PowerSource /* RSMM */
{
        ...
        if (!((Boolean)p_190960_1_.getValue(POWERED)).booleanValue())
        {
            if (!p_190960_2_.isUpdateScheduled(pos, this))
            {
                ...
                if(CarpetSettings.observerPoweredTerracotta){
                    EnumFacing enumfacing = p_190960_1_.getValue(FACING);
                    BlockPos blockpos = pos.offset(enumfacing.getOpposite());
                    IBlockState iblockstate = p_190960_2_.getBlockState(blockpos);
                ...
                p_190960_2_.scheduleUpdate(pos, this, delay);
            }
        }
    }
    ...
    public IBlockState getStateForPlacement(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer)
    {
      ...
      //return this.getDefaultState().withProperty(FACING, EnumFacing.getDirectionFromEntityLiving(pos, placer).getOpposite());
        return this.getDefaultState().withProperty(FACING, EnumFacing.getDirectionFromEntityLiving(pos, placer).getOpposite()).withProperty(POWERED, CarpetSettings.observersDoNonUpdate);
    ...
    public int getPowerLevel(World world, BlockPos pos, IBlockState state) {
        return state.getValue(POWERED) ? MAX_POWER : MIN_POWER;
    }
}