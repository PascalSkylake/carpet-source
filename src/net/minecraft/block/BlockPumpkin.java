...
public class BlockPumpkin extends BlockHorizontal
{
    ...
    {
        return worldIn.getBlockState(pos).getBlock().material.isReplaceable() && ( worldIn.getBlockState(pos.down()).isTopSolid() || CarpetSettings.relaxedBlockPlacement); // CM added condition for easier placement
    }
