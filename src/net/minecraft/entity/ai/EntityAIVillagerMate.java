...
public class EntityAIVillagerMate extends EntityAIBase
{
    ...
    {
        if (CarpetSettings.displayMobAI && this.villager.getGrowingAge()<5 && this.villager.getGrowingAge()>0)
        {
            this.villager.setCustomNameTag("Ready to mate");
        }
        if (this.villager.getGrowingAge() != 0)
        {
            if (CarpetSettings.displayMobAI && this.villager.getGrowingAge()>5)
            {
                this.villager.setCustomNameTag("Waiting: "+this.villager.getGrowingAge());
            }
            return false;
        }
        ...
        else
        {
            ...
            if (this.village == null)
            {
                ...
                {
                    this.villager.setCustomNameTag("Outside of a village");
                }
                return false;
            }
            ...
            else
            {
                if (CarpetSettings.displayMobAI)
                {
                    this.villager.setCustomNameTag("Don't want to mate");
                }
                return false;
            }
        }
    ...
    public void startExecuting()
    {
        ...
        if (CarpetSettings.displayMobAI)
        {
            this.villager.setCustomNameTag("In love: 300");
        }
    }
    ...
    public void updateTask()
    {
        ...
        if (CarpetSettings.displayMobAI)
        {
            ...
            {
                this.villager.setCustomNameTag("In love: "+this.matingTimeout);
            }
            else
            {
                this.villager.setCustomNameTag("Ready to mate");
    ...
    public String getTask() {
        return ": " + villager.getName() + " Task: Mating villagers";
    }
}