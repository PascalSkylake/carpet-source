...
public class EntityVillager extends EntityAgeable implements INpc, IMerchant
{
    ...
    private void setAdditionalAItasks()
    {
        if (!this.areAdditionalTasksSet)
        {
            ...
            else if (CarpetSettings.nitwitCrafter && this.getProfession() == 5)
            {
                craftingAI.updateNitwit();
                this.tasks.addTask(6, craftingAI);
            }
            if (CarpetSettings.villagerAutoTrader)
            {
                this.tasks.addTask(6, autotraderAI);
            }
        }
    }
    ...
    public void writeEntityToNBT(NBTTagCompound compound)
    {
        ...
        if (this.buyingList != null)
        {
            ...
            if(CarpetSettings.villagerAutoTrader) compound.setTag("OffersSorted", autotraderAI.getRecipiesForSaving(sortedTradeList));
        }
    ...
    public void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        if (compound.hasKey("Offers", 10))
        {
            ...
            if(CarpetSettings.villagerAutoTrader) autotraderAI.setRecipiesForSaving(compound.getCompoundTag("OffersSorted"), sortedTradeList);
        }
    ...
    public void onDeath(DamageSource cause)
    {
        ...
        if (CarpetSettings.nitwitCrafter && this.getProfession() == 5 || CarpetSettings.villagerInventoryDropFix) craftingAI.dropInventory();
    ...
    private void populateBuyingList()
    {
        ...
        // Added nitwit crafting AI for making automateable crafters out of them. CARPET-XCOM
        if (CarpetSettings.nitwitCrafter && this.getProfession() == 5)
        {
            return;
        }
        ...
        if(CarpetSettings.elytraTradable && getProfession() == 4 && i == 1 && j == 3){
            new EntityVillager.ItemAndEmeraldsToItem(Items.LEATHER, new EntityVillager.PriceInfo(15, 64), Items.EMERALD, new EntityVillager.PriceInfo(20, 64), Items.ELYTRA).addMerchantRecipe(this, this.buyingList, this.rand);
        }
        ...
        if(CarpetSettings.villagerAutoTrader) autotraderAI.sortRepopulatedSortedList(buyingList, buyingListsorted, sortedTradeList);
    }
    ...
    protected void updateEquipmentIfNeeded(EntityItem itemEntity)
    {
        ...
        {
            if(craftingAI.updateEquipment(itemEntity, villagerInventory)) return;
        }
    ...
    static class ItemAndEmeraldsToItem implements EntityVillager.ITradeList
    {
        ...
        public void addMerchantRecipe(IMerchant merchant, MerchantRecipeList recipeList, Random random)
        {
            ...
            recipeList.add(new MerchantRecipe(new ItemStack(this.buyingItemStack.getItem(), i, this.buyingItemStack.getMetadata()), new ItemStack(this.buyingItemStack2.getItem(), j, this.buyingItemStack2.getMetadata()), sellingItemstack));
        }
    }
}