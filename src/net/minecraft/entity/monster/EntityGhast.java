...
public class EntityGhast extends EntityFlying implements IMob
{
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(3, new GhastHelper.AIFollowClues(this)); //[CM rideableGhasts]
        this.tasks.addTask(4, new GhastHelper.AIFindOwner(this)); //[CM rideableGhasts]
        this.targetTasks.addTask(1, new GhastHelper.GhastEntityAIFindEntityNearestPlayer(this)); //CM modified base AI task
    }
