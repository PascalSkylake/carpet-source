...
public abstract class PlayerList
{
    ...
    public void initializeConnectionToPlayer(NetworkManager netManager, EntityPlayerMP playerIn)
    {
        ...
        if (playerIn instanceof EntityPlayerMPFake) //CM fix for fake players having a set position unrelated to NBT
        ...
        CarpetServer.rsmmServer.onPlayerJoin(playerIn); // RSMM
    }
    ...
    {
        CarpetServer.rsmmServer.onPlayerLeave(playerIn); // RSMM
    ...
    public EntityPlayerMP recreatePlayerEntity(EntityPlayerMP playerIn, int dimension, boolean conqueredEnd)
    {
        ...
        if(CarpetSettings.playersTurningInvisibleFix) playerIn.getServerWorld().getChunk(playerIn.chunkCoordX, playerIn.chunkCoordZ).removeEntityAtIndex(playerIn, playerIn.chunkCoordY);
        this.playerEntityList.remove(playerIn);
        ...
        entityplayermp.setCameraData(playerIn);
    ...
    public void transferEntityToWorld(Entity entityIn, int lastDimension, WorldServer oldWorldIn, WorldServer toWorldIn)
    {
        ...
        if (CarpetSettings.playersTurningInvisibleFix && entityIn.addedToChunk && oldWorldIn.isChunkLoaded(entityIn.chunkCoordX, entityIn.chunkCoordZ, true)) {
