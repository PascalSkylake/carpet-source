...
public final class ItemStack
{
    ...
    public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        {
            // CM add meta
            playerIn.addStat(StatHelper.getObjectUseStats(this.item, this.itemDamage));
        }
    ...
    public int getMaxStackSize()
    {
        ...
        if(CarpetSettings.stackableShulkersPlayerInventory && CarpetServer.playerInventoryStacking && !hasTagCompound() && this.getItem() instanceof ItemShulkerBox) return 64;
    ...
    {
        // CM add meta
        playerIn.addStat(StatHelper.getCraftStats(this.item, this.itemDamage), amount);
	...
	public boolean isGroundStackable() {
		return this.getItem().itemGroundStacking(hasTagCompound());
	}
	public void forceStackSize(int size){this.stackSize = size;}
}