...
public class ItemBlockSpecial extends Item
{
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        if (!itemstack.isEmpty() && player.canPlayerEdit(pos, facing, itemstack) && worldIn.mayPlace(this.block, pos, false, facing, (Entity)null))
        {
            ...
            {
                iblockstate1 = BlockRotator.alternativeBlockPlacement(this.block, worldIn, pos, facing, hitX, hitY, hitZ, 0, player);
            }
            if (iblockstate1 == null) // vanilla
            {
                iblockstate1 = this.block.getStateForPlacement(worldIn, pos, facing, hitX % 2.0F, hitY, hitZ, 0, player);
            }
