                    ...
                    else if (slot6.canTakeStack(player))
                    {
                        if (itemstack11.isEmpty())
                        {
                            ...
                            else
                            {
                                ...
                                inventoryplayer.setItemStack(decrStackSize(player, slotId, l2));
                        ...
                        {
                            if (itemstack8.getItem() == itemstack11.getItem() && itemstack8.getMetadata() == itemstack11.getMetadata() && ItemStack.areItemStackTagsEqual(itemstack8, itemstack11) && itemstack11.isStackable()) // Check If item can stack, Always true in vanilla CARPET-XCOM
                            {
        ...
        else if (clickTypeIn == ClickType.THROW && inventoryplayer.getItemStack().isEmpty() && slotId >= 0)
        {
            ...
            if (slot2 != null && slot2.getHasStack() && slot2.canTakeStack(player))
            {
                ...
                else
                {
                    ...
                    ItemStack itemstack4 = decrStackSize(player, slotId, dragType == 0 ? 1 : slot2.getStack().getCount());
