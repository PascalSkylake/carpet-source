...
public class ChunkGeneratorOverworld implements IChunkGenerator
{
    ...
    public final WoodlandMansion woodlandMansionGenerator = new WoodlandMansion(this);
    ...
    public List<Biome.SpawnListEntry> getPossibleCreatures(EnumCreatureType creatureType, BlockPos pos)
    {
        ...
        if (this.mapFeaturesEnabled)
        {
            ...
            if (CarpetSettings.huskSpawningInTemples && creatureType == EnumCreatureType.MONSTER && this.scatteredFeatureGenerator.isTemple(pos))
            {
                return this.scatteredFeatureGenerator.getScatteredFeatureSpawnListHusk();
            }
        }
