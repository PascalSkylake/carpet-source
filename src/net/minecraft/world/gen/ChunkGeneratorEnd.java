...
public class ChunkGeneratorEnd implements IChunkGenerator
{
    ...
    public Chunk generateChunk(int x, int z)
    {
        if (CarpetSettings.endChunkSeed != 0) {
            ...
            this.lastRandomSeed = (long)x * 341873128712L + (long)z * 132897987541L;
        }
    ...
    public List<Biome.SpawnListEntry> getPossibleCreatures(EnumCreatureType creatureType, BlockPos pos)
    {
        if(CarpetSettings.shulkerSpawningInEndCities && EnumCreatureType.MONSTER == creatureType)
        {
            ...
            {
                return this.endCityGen.getSpawnList();
            }
        }
    ...
    public void recreateStructures(Chunk chunkIn, int x, int z)
    {
        ...
        if (CarpetSettings.shulkerSpawningInEndCities) this.endCityGen.generate(this.world, x, z, (ChunkPrimer)null);
    }
