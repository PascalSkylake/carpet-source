...
public abstract class MapGenStructure extends MapGenBase
{
    ...
    public NBTTagList getBoundingBoxes(Entity entity, int type)
    {
        ...
        while (objectiterator.hasNext())
        {
            ...
            Iterator<StructureComponent> iterator = structurestart.getComponents().iterator();
            tagCompound.setInteger("type", CarpetClientMarkers.OUTER_BOUNDING_BOX);
            tagCompound.setTag("bb", structurestart.getBoundingBox().toNBTTagIntArray() );
            ...
            while (iterator.hasNext())
            {
                ...
                compound.setTag("bb", structurecomponent.getBoundingBox().toNBTTagIntArray() );
